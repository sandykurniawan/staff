                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-header">
                                        <!--<img src="<?php echo base_url('assets/AdminLTE-2.0.5/dist/img/user2-160x160.jpg') ?>" class="img-circle" alt="User Image" /> -->
                                         <img src="https://api.qrserver.com/v1/create-qr-code/?data=https://www.facebook.com/sandyjrs.kurniawan&size=100x100" alt="" title="" />
                                        <p>
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <a href="<?php echo site_url('admin/idcard') ?>" target="_blank" class="btn btn-default btn-flat">Change Password</a>
                                        </div>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            <a href="<?php echo site_url('admin/sendEmail') ?>">
                                <i class="glyphicon glyphicon-user"></i>
