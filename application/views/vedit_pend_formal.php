...
<head>
  ...
  <title>STAFF SITE | Riwayat Pendidikan</title>
	        ...
	        <form class="form-horizontal">    
	            ...
	            <div class="box-body">
	            	<div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control"  placeholder="Masukkan Email Alternatif Anda">
                        </div>
                    </div>
	            </div><!-- /.box-body -->
              <div class="box-body">
            ...
            <form class="form-horizontal">
              ...
              <div class="box-body">
                <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control"  placeholder="Masukkan ID LinkedIN Anda">
                        </div>
                    </div>
              </div><!-- /.box-body -->
              <div class="box-body">
                <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" rows="3" placeholder="Masukkan Interest Subject Anda"></textarea>
                        </div>
                    </div>
              </div><!-- /.box-body -->
              <div class="box-body">
                <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control"  placeholder="Masukkan Scholar Anda">
                        </div>
                    </div>
              </div><!-- /.box-body -->
            </form>
